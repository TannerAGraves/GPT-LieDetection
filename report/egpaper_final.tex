...
The Future Intentions Dataset is comprised of 1640 examples (with two answers each?).
...
The hyperparameters used for fine-tuning the models are declared in the tables below, together with the fine-tuning training losses over the steps.
...
\begin{center}
\includegraphics*[scale=0.6]{img/cross_validation.png} \\
\small {Cross-Validation Process Diagram.} \\
\end{center} 
...
\begin{center}
    ...
    \small {Class-wise accuracy of Cross-Validated model compared.}
\end{center}
