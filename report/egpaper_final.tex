...
%%%%%%%%% TITLE
\title{Fine-Tuning GPT3 to Explore and Evaluate its Lie Detection Capabilities}
...
%%%%%%%%% ABSTRACT
\begin{abstract}
This paper aims at evaluating the capabilities of GPT3 in the task of Lie Detection.
...
line with the desired task objectives. In our case, the objective is to classify truth or deception.
